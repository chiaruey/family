...
angular.module('loginView', ['ngMessages', 'ngAnimate']) 
    ...
    .directive('single', function() {
    	return {
    	    restrict: 'E',
    	    template: '<p>Demo user for a single person</p>\
    	    	<table class="demoUserTable">\
	...
	.directive('couple', function(){
		return {
			restrict: 'E',
			template: '<p>Demo users for a family of two </p>\
				<table class="demoUserTable"><tr><th>username:</th><th>password:</th></tr>\
	...
	.directive('familyof4', function(){
		return {
			restrict: 'E',
			template: '<p>Demo users for a family of four </p>\
				<table class="demoUserTable" ><tr><th>username:</th><th>password:</th></tr>\
